      ...
      <div className="max-w-7xl mx-auto px-10 grid lg:grid-cols-2 gap-14 items-center">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-gray-700 max-w-xl">
            Our organization began with a simple belief — that small acts
            of kindness can ripple outward and transform communities.
            Through education programs, hospital support, food initiatives,
            and clothing drives, we work to restore dignity and opportunity
