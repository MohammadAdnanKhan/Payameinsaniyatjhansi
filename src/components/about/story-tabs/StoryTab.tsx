  ...
  const story = [
    {
      ...
      text: (
        <>
          ...
          access basic necessities such as food, clothing, and medicines.
          Seeing their hardships inspired us to step forward and help those in
          need — whether they were homeless individuals, daily wage workers,
          or travelers stranded without support.
        </>
      )
    },
    {
    ...
    },
    {
      ...
      text: (
        <>
          ...
          </span>, we continue striving to create a{" "}
